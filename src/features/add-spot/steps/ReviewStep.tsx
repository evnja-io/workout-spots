...
export function ReviewStep({ values }: ReviewStepProps) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '13px' }}>
      <div>
        <span className="field-label">{t('addSpot.nameLabel')}</span>
        <p style={{ margin: 0, color: 'var(--text)' }}>{values.name}</p>
      </div>

      <div>
        <span className="field-label">{t('addSpot.addressLabel')}</span>
      ...
      <div>
        <span className="field-label">{t('addSpot.coordsLabel')}</span>
      ...
      <div>
        <span className="field-label">{t('addSpot.disciplinesLabel')}</span>
        <p style={{ margin: 0, color: 'var(--text-3)' }}>
      ...
      {values.equipment.length > 0 && (
        <div>
          <span className="field-label">{t('addSpot.equipmentLabel')}</span>
          <p style={{ margin: 0, color: 'var(--text-3)' }}>
